...
NOTES:
* no drag'n'drop, first click selects and picks block, second click leaves it
...
export class Test_jigsaw_game extends BaseGame
{
    ...
    update(deltaTime: number) 
    {
        ...
        //if(BaseGame.mouseDown) console.log(" mouse down");
